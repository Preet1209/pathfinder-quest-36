...
export const OnboardingQuiz = () => {
  ...
  const canProceed = (): boolean => {
    switch (currentQuestion) {
      ...
      case 1: return !!answers.hoursPerWeek;
      case 2: return answers.domains.length >= 1;
      case 3: return answers.valuesRanking.length === 3;
      case 4: return !!answers.stabilityVsFlexibility;
      case 5: return !!answers.independentVsCollaborative;
      case 6: return !!answers.expertVsVersatile;
      case 7: return true; // sliders always have values
      case 8: return !!answers.learningStyle;
      case 9: return answers.desiredSkill.trim().length >= 3;
  ...
  const renderQuestion = () => {
    switch (currentQuestion) {
      case 0: return <JourneyStage />;
      case 1: return <HoursPerWeek />;
      case 2: return <DomainChips />;
      case 3: return <ValuesRanking />;
      case 4:
        return (
          <ABChoice
            field="stabilityVsFlexibility"
      ...
      case 5:
        return (
          <ABChoice
            field="independentVsCollaborative"
      ...
      case 7: return <StressSliders />;
      case 8: return <LearningStyle />;
      case 9: return <DesiredSkill />;
      default: return null;
    }
  };
